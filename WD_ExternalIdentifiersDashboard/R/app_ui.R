                  ...
                  dashboardBody(
                    ...
                    tabItems(
                      ...
                      tabItem(tabName = "similarityMap",
                              ...
                              fluidRow(
                                column(width = 12,
                                       shinycssloaders::withSpinner(plotly::plotlyOutput("globalMap",
                                                                width = "100%",
                                                                height = "900px"))
                                )
                              ),
                      ...
                      tabItem(tabName = "tables",
                              ...
                              fluidRow(
                                column(width = 6, 
                                       shinycssloaders::withSpinner(DT::dataTableOutput('overlapDT', width = "100%"))
                                ),
                                column(width = 6,
                                       shinycssloaders::withSpinner(DT::dataTableOutput('usageDT', width = "100%"))
                                )
                              ),
                              fluidRow(
                                hr(),
                      ...
                      tabItem(tabName = "identifierClusters",
                              ...
                              fluidRow(
                                column(width = 8,
                                       shinycssloaders::withSpinner(plotly::plotlyOutput("localSimilarityGraph",
                                                                width = "100%",
                                                                height = "500px")
                                       )
                                ),
                                column(width = 4, 
                                       shinycssloaders::withSpinner(DT::dataTableOutput('identifierClassList', width = "100%")
                                       )
                                )
                              ),
                              fluidRow(
                      ...
                      tabItem(tabName = "particularIdentifier",
                              ...
                              fluidRow(
                                ...
                                column(width = 6,
                                       ...
                                       fluidRow(
                                         column(width = 12,
                                                shinycssloaders::withSpinner(plotly::plotlyOutput("identifierSimilarityGraph",
                                                                         width = "100%",
                                                                         height = "500px")
                                                )
                                         )
                                ...
                                column(width = 6,
                                       ...
                                       shinycssloaders::withSpinner(DT::dataTableOutput("examplesDT",
                                                                       width = "100%")
                                       )   
                                )
                              ),
...
golem_add_external_resources <- function(){
  ...
  tags$head(
    ...
    bundle_resources(
      ...
      app_title = 'WD_ExternalIdentifiersDashboard'
    )
