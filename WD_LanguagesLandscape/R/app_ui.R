                    ...
                    tabItems(
                      ...
                      tabItem(tabName = "datamodel",
                              fluidRow(
                                ...
                                column(width = 3,
                                       HTML('<p style="font-size:80%;"align="left">
                              ...
                              fluidRow(
                                column(width = 12, 
                                       h3('ALL WIKIDATA ITEMS'))
                              ),
                              fluidRow(
                                column(width = 4,
                                       align = "left",
                                       HTML('<p style="font-size:80%;"align="left">The <b>average</b> number of labels per item.</p>'),
                                       shinycssloaders::withSpinner(dygraphs::dygraphOutput("datamodelLabels")),
                                       hr()
                                ),
                                column(width = 4,
                                       align = "left",
                                       HTML('<p style="font-size:80%;"align="left">The <b>average</b> number of descriptions per item.</p>'),
                                       shinycssloaders::withSpinner(dygraphs::dygraphOutput("datamodelDescriptions")),
                                       hr()
                                ),
                                column(width = 4,
                                       align = "left",
                                       HTML('<p style="font-size:80%;"align="left">The <b>average</b> number of aliases per item.</p>'),
                                       shinycssloaders::withSpinner(dygraphs::dygraphOutput("datamodelAliases")),
                                       hr()
                                )
                              ),
                              fluidRow(
                                column(width = 12, 
                                       h3('ASTRONOMICAL OBJECTS (Q6999 + its subclasses)'))
                              ),
                              fluidRow(
                                column(width = 4,
                                       align = "left",
                                       HTML('<p style="font-size:80%;"align="left">The <b>average</b> number of labels per item.</p>'),
                                       shinycssloaders::withSpinner(dygraphs::dygraphOutput("datamodelLabels_ASTRONOMY")),
                                       hr()
                                ),
                                column(width = 4,
                                       align = "left",
                                       HTML('<p style="font-size:80%;"align="left">The <b>average</b> number of descriptions per item.</p>'),
                                       shinycssloaders::withSpinner(dygraphs::dygraphOutput("datamodelDescriptions_ASTRONOMY")),
                                       hr()
                                ),
                                column(width = 4,
                                       align = "left",
                                       HTML('<p style="font-size:80%;"align="left">The <b>average</b> number of aliases per item.</p>'),
                                       shinycssloaders::withSpinner(dygraphs::dygraphOutput("datamodelAliases_ASTRONOMY")),
                                       hr()
                                )
                              ),
                              fluidRow(
                                column(width = 12, 
                                       h3('SCHOLARLY ARTICLE (Q13442814 + its subclasses)'))
                              ),
                              fluidRow(
                                column(width = 4,
                                       align = "left",
                                       HTML('<p style="font-size:80%;"align="left">The <b>average</b> number of labels per item.</p>'),
                                       shinycssloaders::withSpinner(dygraphs::dygraphOutput("datamodelLabels_SCIENTIFICPAPERS")),
                                       hr()
                                ),
                                column(width = 4,
                                       align = "left",
                                       HTML('<p style="font-size:80%;"align="left">The <b>average</b> number of descriptions per item.</p>'),
                                       shinycssloaders::withSpinner(dygraphs::dygraphOutput("datamodelDescriptions_SCIENTIFICPAPERS")),
                                       hr()
                                ),
                                column(width = 4,
                                       align = "left",
                                       HTML('<p style="font-size:80%;"align="left">The <b>average</b> number of aliases per item.</p>'),
                                       shinycssloaders::withSpinner(dygraphs::dygraphOutput("datamodelAliases_SCIENTIFICPAPERS")),
                                       hr()
                                )
                              ),
                              fluidRow(
                                column(width = 12, 
                                       h3('WIKIDATA - (SCHOLARLY ARTICLE + ASTRONOMICAL OBJECT)'))
                              ),
                              fluidRow(
                                column(width = 4,
                                       align = "left",
                                       HTML('<p style="font-size:80%;"align="left">The <b>average</b> number of labels per item.</p>'),
                                       shinycssloaders::withSpinner(dygraphs::dygraphOutput("datamodelLabels_EVERYTHINGMINUS")),
                                       hr()
                                ),
                                column(width = 4,
                                       align = "left",
                                       HTML('<p style="font-size:80%;"align="left">The <b>average</b> number of descriptions per item.</p>'),
                                       shinycssloaders::withSpinner(dygraphs::dygraphOutput("datamodelDescriptions_EVERYTHINGMINUS")),
                                       hr()
                                ),
                                column(width = 4,
                                       align = "left",
                                       HTML('<p style="font-size:80%;"align="left">The <b>average</b> number of aliases per item.</p>'),
                                       shinycssloaders::withSpinner(dygraphs::dygraphOutput("datamodelAliases_EVERYTHINGMINUS")),
                                       hr()
                                )
                              ),
                              fluidRow(
                                column(width = 12, 
                                       h3('SELECTED LANGUAGE'))
                              ),
                              fluidRow(
                                column(width = 4,
                                       align = "left",
                              ...
                              fluidRow(
                                column(width = 4,
                                       align = "left",
                                       HTML('<p style="font-size:80%;"align="left">The <b>total</b> number of labels per language.</p>'),
                                       shinycssloaders::withSpinner(dygraphs::dygraphOutput("dataModelLang_Labels")),
                                       hr()
                                ),
                                column(width = 4,
                                       align = "left",
                                       HTML('<p style="font-size:80%;"align="left">The <b>total</b> number of descriptions per language.</p>'),
                                       shinycssloaders::withSpinner(dygraphs::dygraphOutput("dataModelLang_Descriptions")),
                                       hr()
                                ),
                                column(width = 4,
                                       align = "left",
                                       HTML('<p style="font-size:80%;"align="left">The <b>total</b> number of aliases per language.</p>'),
                                       shinycssloaders::withSpinner(dygraphs::dygraphOutput("dataModelLang_Aliases")),
                                       hr()
                                )
                              ),
                              fluidRow(
                      ...
                      tabItem(tabName = "ontology",
                              ...
                              fluidRow(
                                column(width = 12,
                                       shinycssloaders::withSpinner(plotly::plotlyOutput("ontologyGraph",
                                                                width = "100%",
                                                                height = "900px"))                                     
                                )
                              ),
                      ...
                      tabItem(tabName = "languageclass",
                              ...
                              fluidRow(
                                column(width = 12,
                                       shinycssloaders::withSpinner(visNetwork::visNetworkOutput('languageClassGraph', height = 700))
                                ...
                                column(width = 12,
                                       tabBox(id = 'tabset1', 
                                              ...
                                              tabPanel("Static/Clusters",
                                                       fluidRow(
                                                         column(width = 6,
                                                                shinycssloaders::withSpinner(plotOutput('similarityGraph_Static', 
                                                                                       width = "100%",
                                                                                       height = "900px"))
                                                         )
                                                       )
                                              ...
                                              tabPanel("Interactive/Clusters",
                                                       fluidRow(
                                                         column(width = 7,
                                                                shinycssloaders::withSpinner(plotly::plotlyOutput("similarityGraph",
                                                                                         width = "100%",
                                                                                         height = "900px"))                                                       )
                                                       )
                                              )
                      ...
                      tabItem(tabName = "status",
                              ...
                              fluidRow(
                                column(width = 12,
                                       fluidRow(
                                         column(width = 6,
                                                shinycssloaders::withSpinner(plotly::plotlyOutput('status_UNESCO_Sitelinks',
                                                                         width = "100%",
                                                                         height = "650px")),
                                                br(), 
                                                ...
                                                hr()),
                                         column(width = 6,
                                                shinycssloaders::withSpinner(plotly::plotlyOutput('status_Ethnologue_Sitelinks',
                                                                         width = "100%",
                                                                         height = "650px")),
                                                br(),
                              ...
                              fluidRow(
                                column(width = 12,
                                       fluidRow(
                                         column(width = 6,
                                                shinycssloaders::withSpinner(plotly::plotlyOutput('status_UNESCO_numItems',
                                                                         width = "100%",
                                                                         height = "650px")),
                                                br(), 
                                                ...
                                                hr()),
                                         column(width = 6,
                                                shinycssloaders::withSpinner(plotly::plotlyOutput('status_Ethnologue_numItems',
                                                                         width = "100%",
                                                                         height = "650px")),
                                                br(), 
                              ...
                              fluidRow(
                                column(width = 12,
                                       fluidRow(
                                         column(width = 6,
                                                shinycssloaders::withSpinner(plotly::plotlyOutput('status_UNESCO_reuse',
                                                                         width = "100%",
                                                                         height = "650px")),
                                                br(), 
                                                ...
                                                hr()),
                                         column(width = 6,
                                                shinycssloaders::withSpinner(plotly::plotlyOutput('status_Ethnologue_reuse',
                                                                         width = "100%",
                                                                         height = "650px")),
                                                br(), 
                      ...
                      tabItem(tabName = "usage",
                              ...
                              fluidRow(
                                column(width = 12,
                                       fluidRow(
                                         column(width = 6,
                                                shinycssloaders::withSpinner(plotly::plotlyOutput('labels_Reuse',
                                                                         width = "100%",
                                                                         height = "650px")),
                                                br(), 
                                                ...
                                                hr()),
                                         column(width = 6,
                                                shinycssloaders::withSpinner(plotly::plotlyOutput('log_labels_Reuse',
                                                                         width = "100%",
                                                                         height = "650px")),
                                                br(), 
                                                HTML('<p style="font-size:80%;"align="left"><b>Number of labels and the total WDCM reuse statistic.</b> 
                              ...
                              fluidRow(
                                column(width = 12,
                                       fluidRow(
                                         column(width = 6,
                                                shinycssloaders::withSpinner(plotly::plotlyOutput('itemCount_avgReuse',
                                                                         width = "100%",
                                                                         height = "650px")),
                                                br(), 
                                                ...
                                                hr()),
                                         column(width = 6,
                                                shinycssloaders::withSpinner(plotly::plotlyOutput('itemCount_propReused',
                                                                         width = "100%",
                                                                         height = "650px")),
                                                br(), 
                                                HTML('<p style="font-size:80%;"align="left"><b>Number of labels and the average WDCM reuse statistic.</b> 
...
golem_add_external_resources <- function(){
  ...
  tags$head(
    ...
    bundle_resources(
      ...
      app_title = 'WD_LanguagesLandscape'
    )
