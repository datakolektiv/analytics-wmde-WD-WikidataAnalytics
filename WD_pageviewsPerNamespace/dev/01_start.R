...
## 
golem::fill_desc(
  pkg_name = "WDPageviews", # The Name of the package containing the App 
  pkg_title = "WMDE Wikidata Pageviews per Namespace App", # The Title of the package containing the App 
