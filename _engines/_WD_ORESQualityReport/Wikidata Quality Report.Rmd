...
```{r echo = T}
stats <- read.csv('_data/dataQuality_Stats.csv', 
                  header = T, 
                  check.names = F, 
                  stringsAsFactors = F)
```
...
```{r echo = T}
dataA <- read.csv('_data/dataQuality_oresScoresDistribution.csv',
                 header = T,
                 check.names = F,
                 stringsAsFactors = F,
                 row.names = 1)
...
```{r echo = T}
dataB <- read.csv('_data/dataQuality_oresScoresDistribution_10000.csv',
                 header = T,
                 check.names = F,
                 stringsAsFactors = F,
                 row.names = 1)
...
![](_data/scoreUsage_BoxPlot_ggplot2_outliers_removed.png)
...
![](_data/scoreUsage_BoxPlot_ggplot2.png)
...
![](_data/scoreUsage_BoxPlot_ggplot2_outliers_removed_unique_values.png)
...
![](_data/distribution_Quality_USage.png)
...
![](_data/revids_timeline_quality_classes.png)
...
```{r echo = T}
critical <- read.csv('_data/positiveOutliers.csv',
                 header = T,
                 check.names = F,
                 stringsAsFactors = F,
                 row.names = 1)
