...
# - to runtime Log:
print(paste("--- wdll_Similarity.R. Store co-occurences: WD_Languages_Co-Occurrence.csv.", 
            Sys.time(), sep = " "))
write.csv(lang, 
...
# - to runtime Log:
print(paste("--- wdll_Similarity.R. Compute similarity and distance matrix from co-occurrences", 
            Sys.time(), sep = " "))
...
# - to runtime Log:
print(paste("--- wdll_Similarity.R. tSNE 2D map from cosineDistMatrix_Frame.", 
            Sys.time(), sep = " "))
...
# - to runtime Log:
print(paste("--- wdll_Similarity.R. compute binary co-occurrences for the Jaccard Similarity Matrix.", 
            Sys.time(), sep = " "))
t1 <- Sys.time()
...
# - to runtime Log:
print(paste("--- wdll_Similarity.R. store WD_Languages_Jaccard_Distance.csv.", 
            Sys.time(), sep = " "))
write.csv(distMatrix, 
